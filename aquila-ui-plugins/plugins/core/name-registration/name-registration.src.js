...
class NameRegistration extends LitElement {
            ...
            <div id="name-registration-page">
                ...
                <mwc-dialog id="registerNameDialog" scrimClickAction="${this.registerNameLoading ? '' : 'close'}">
                    ...
                    <div style="text-align:right; height:36px;">
                        ...
                        <span>
                            <b>${translate("registernamepage.nchange13")} ${this.fee} UNCIA.</b>
                        </span>
                    </div>
                    <mwc-button
                        ?disabled="${this.registerNameLoading}"
                ...
                <mwc-dialog id="updateNameDialog" scrimClickAction="" escapeKeyAction="">
                    ...
                    <div style="text-align:right; height:36px;">
                        ...
                        <span>
                            <b>${translate("walletpage.wchange21")} ${this.updateFee} UNCIA.</b>
                        </span>
                    </div>
                    <mwc-button
                        slot="primaryAction"
                    ...
                    <div class="manage-group-dialog">
                        ...
                        <p>
                            <mwc-textfield
                                ...
                                outlined
                                id="toSellPrice"
                                label="${translate("registernamepage.nchange23")} (UNCIA)"
                                type="number"
                        ...
                        <div style="margin-bottom: 10px;">
                            <p style="margin-bottom: 0;">${translate("walletpage.wchange21")} <span style="font-weight: bold;">${this.sellFee} UNCIA<span></p>
                            <br>
                        </div>
                ...
                <mwc-dialog id="cancelSellNameDialog" scrimClickAction="" escapeKeyAction="">
                    <div class="manage-group-dialog">
                        ...
                        <div style="margin-bottom: 10px;">
                            <p style="margin-bottom: 0;">${translate("walletpage.wchange21")} <span style="font-weight: bold;">${this.cancelSellFee} UNCIA<span></p>
                            <br>
                        </div>
                        ${this.renderClearSuccess()}
                        ${this.renderClearError()}
    ...
    async updateUnciaWalletBalance() {
        let unciaAddress = window.parent.reduxStore.getState().app.selectedAddress.address

        await parentEpml.request('apiCall', {
            url: `/addresses/balance/${unciaAddress}`,
        }).then((res) => {
    ...
    async uploadAvatar(nameObj) {
        let name = nameObj.name
        window.location.href = `../qdn/publish/index.html?service=THUMBNAIL&identifier=aquila_avatar&name=${name}&uploadType=file&category=Avatar&showName=false&showService=false&showIdentifier=false`
    }
    ...
    async openCheckFunds() {
        ...
        const myFunds = this.round(parseFloat(this.unciaWalletBalance))
