...
[part="input-field"] {
        ...
        return html`
            ...
            <mwc-dialog id="createBanMemberDialog" scrimClickAction="" escapeKeyAction="">
                <div class="manage-group-dialog">
                    ...
                    <div style="margin-bottom: 10px;">
                        <p style="margin-bottom: 0;">${translate("walletpage.wchange21")} <span style="font-weight: bold;">${this.addGroupAdminFee} UNCIA<span></p>
                        <br>
                    </div>
            ...
            <mwc-dialog id="kickGroupMemberDialog" scrimClickAction="" escapeKeyAction="">
                <div class="manage-group-dialog">
                    ...
                    <div style="margin-bottom: 10px;">
                        <p style="margin-bottom: 0;">${translate("walletpage.wchange21")} <span style="font-weight: bold;">${this.kickGroupMemberFee} UNCIA<span></p>
                        <br>
                    </div>
                    ${this.renderClearSuccess()}
                    ${this.renderClearError()}
        ...
        return html`
            ...
            <mwc-dialog id="cancelBanMemberDialog" scrimClickAction="" escapeKeyAction="">
                <div class="manage-group-dialog">
                    ...
                    <div style="margin-bottom: 10px;">
                        <p style="margin-bottom: 0;">${translate("walletpage.wchange21")} <span style="font-weight: bold;">${this.cancelBanFee} UNCIA<span></p>
                        <br>
                    </div>
                    ${this.renderClearSuccess()}
                    ${this.renderClearError()}
        ...
        return html`
            ...
            <mwc-dialog id="inviteMemberToGroupDialog" scrimClickAction="" escapeKeyAction="">
                <div class="manage-group-dialog">
                    ...
                    <div style="margin-bottom: 10px;">
                        <p style="margin-bottom: 0;">${translate("walletpage.wchange21")} <span style="font-weight: bold;">${this.inviteGroupMemberFee} UNCIA<span></p>
                        <br>
                    </div>
                    ${this.renderClearSuccess()}
                    ${this.renderClearError()}
            ...
            <mwc-dialog id="cancelInviteMemberToGroupDialog" scrimClickAction="" escapeKeyAction="">
                <div class="manage-group-dialog">
                    ...
                    <div style="margin-bottom: 10px;">
                        <p style="margin-bottom: 0;">${translate("walletpage.wchange21")} <span style="font-weight: bold;">${this.cancelInviteGroupMemberFee} UNCIA<span></p>
                        <br>
                    </div>
                    ${this.renderClearSuccess()}
                    ${this.renderClearError()}
        ...
        return html`
            ...
            <mwc-dialog id="kickGroupAdminDialog" scrimClickAction="" escapeKeyAction="">
                <div class="manage-group-dialog">
                    ...
                    <div style="margin-bottom: 10px;">
                        <p style="margin-bottom: 0;">${translate("walletpage.wchange21")} <span style="font-weight: bold;">${this.kickGroupAdminFee} UNCIA<span></p>
                        <br>
                    </div>
                    ${this.renderClearSuccess()}
                    ${this.renderClearError()}
    ...
    renderAvatar(groupObj) {
        ...
        const myNode = window.parent.reduxStore.getState().app.nodeConfig.knownNodes[window.parent.reduxStore.getState().app.nodeConfig.node]
        const nodeUrl = myNode.protocol + '://' + myNode.domain + ':' + myNode.port
        const url = `${nodeUrl}/arbitrary/THUMBNAIL/${name}/aquila_avatar?async=true&apiKey=${this.getApiKey()}`
