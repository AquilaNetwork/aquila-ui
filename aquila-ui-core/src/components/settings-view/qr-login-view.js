...
import '../../../../aquila-ui-plugins/plugins/core/components/AquilaQrcodeGenerator.js'
        ...
        <div style="position: relative;" >
            <div class="center-box">
                ...
                <div id="login-qr-code" style="display: none;">
                    <aquila-qrcode-generator id="login-qr-code" data="${this.savedWalletDataJson}" mode="octet" format="html" auto></aquila-qrcode-generator>
                </div>
            </div>
        </div>
    `
