...
class UnciaThemeToggle extends LitElement {
  ...
  toggleTheme() {
    ...
    this.dispatchEvent(
      new CustomEvent('uncia-theme-change', {
        bubbles: true,
        composed: true,
        detail: this.theme,
      }),
    ...
    window.localStorage.setItem('aquilaTheme', this.theme);
    this.initTheme();
  }
...
window.customElements.define('uncia-theme-toggle', UnciaThemeToggle);
