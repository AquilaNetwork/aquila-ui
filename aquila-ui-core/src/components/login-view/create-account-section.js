...
import { createWallet } from '../../../../aquila-ui-crypto/api/createWallet.js'
...
class CreateAccountSection extends connect(store)(LitElement) {
    ...
    async downloadBackup(wallet) {
        ...
        FileSaver.saveAs(blob, `aquila_backup_${wallet.addresses[0].address}.json`)
    }
    ...
    downloadSeedphrase() {
        ...
        FileSaver.saveAs(blob, `aquila_seedphrase.txt`)
    }
}
